...
public class CloseCombat {
	...
	public int closeCombat (Unit a, Unit b){
		...
		if(a.initiative>b.initiative || a.strikeFirst && !b.strikeFirst || !a.strikeLast && b.strikeLast)
			System.out.println("Die " + a.name +" der " + a.race +" schlagen zuerst zu!");
		
		if(b.initiative>a.initiative || b.strikeFirst && !a.strikeFirst || !b.strikeLast && a.strikeLast)
			System.out.println("Die " + b.name +" der " + b.race +" schlagen zuerst zu!");
